function element = applyMMitsubaMappingOperation(mitsubaScene, mapping, varargin)
%% Create/Find/Delete an mMitsuba element for the given mapping struct.
%
% element = applyMMitsubaMappingOperation(mitsubaScene, mapping) uses the
...
%
% applyMMitsubaMappingOperation(mitsubaScene( ... 'type', type)

function element = applyMPbrtMappingOperation(pbrtScene, mapping, varargin)
%% Create/Find/Delete an mPbrt element for the given mapping struct.
%
% element = applyMPbrtMappingOperation(pbrtScene, mapping) uses the given
% mapping to create, find, or delete an appropriate element of the given
% pbrtScene, as directed by the given mapping.operation.
%
% applyMPbrtMappingOperation(pbrtScene( ... 'identifier', identifier)

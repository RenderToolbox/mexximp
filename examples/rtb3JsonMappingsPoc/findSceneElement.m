function element = findSceneElement(scene, varargin)
%% Search for a scene element, based on the given name, type, and/or index.
%
% element = findSceneElement(scene, name, broadType, index) searches the
...
%
% element = findSceneElement(scene, name, broadType, index)
%

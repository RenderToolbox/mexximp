function mexximpWriteTriangleMeshPly(outputFile, xyz, faces, varargin)
%% Write a PLY mesh file with optional normals, UVs, and colors.
%
% mexximpWriteTriangleMeshPly(outputFile, xyz, faces) writes a new Stanford
...
%     3 1 2 3
%
% mexximpWriteTriangleMeshPly( ... 'normals', normals) specifies a 3xn matrix of
% XYZ normals for each vertex, to include along with the xyz position data.
%
% mexximpWriteTriangleMeshPly( ... 'uvs', uvs) specifies a 2xn matrix of
...
%
% mexximpWriteTriangleMeshPly( ... 'colors', colors) specifies a 3xn matrix of
...
%
% mexximpWriteTriangleMeshPly( ... 'format', format) specifies the encoding of the
...
%     3 1 2 3
%
%   mexximpWriteTriangleMeshPly(outputFile, xyz, faces, varargin)
%
% BSH

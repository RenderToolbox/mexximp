function mitsubaNodes = mexximpNodeToMMitsuba(scene, node, meshFiles, materialIds, varargin)
%% Convert a mexximp nodes to Mitsuba ply shape elements.
%
% mitsubaNodes = mexximpNodeToMMitsuba(scene, node, meshFiles) converts the
...
% material.
%
% mitsubaNodes = mexximpNodeToMMitsuba(scene, node, varargin)
%
